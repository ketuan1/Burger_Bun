          ...
          <div className="row align-items-center py-lg-5 py-4 mt-4">
            <div className="col-lg-6 col-sm-12">
              ...
              <p>
                ...
                have updated our safety measures. Lorem ipsum dolor sit amet
                elit. Provident. fugit odit? Fugit ipsam. Sed ac ex. Nam mauris
                velit, ac cursus quis, leo.
              </p>
              <div className="mt-md-5 mt-4">
                <a className="btn btn-primary btn-style mr-2" href="menu.html">
                  {" "}
                  See Menu{" "}
                </a>
                <a className="btn btn-outline-primary btn-style" href="#call">
                  {" "}
                  Book a table{" "}
                </a>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6 mt-lg-0 mt-md-5 mt-4 about-right-faq align-self">
                ...
                <h3 className="title-big">
                  Burgers! You won't Find Anywhere Else with Best Quality{" "}
                  <span>Ingredients</span>
                </h3>
                <p className="mt-sm-4 mt-3">
                  Lorem ipsum viverra feugiat. Pellen tesque libero ut justo,
                  ultrices in ligula. Semper at tempufddfel. Lorem ipsum dolor
                  sit amet consectetur adipisicing elit. Non quae, consequatur
                  voluptatem ad.
                </p>
                <a
                  className="btn btn-primary btn-style mt-md-5 mt-4 mr-2"
                  href="about.html"
                >
                  {" "}
                  Read More{" "}
      ...
      <div className="middle py-5" id="call">
        <div className="container py-lg-3">
          <div className="welcome-left text-center py-md-5 py-3">
            <h3>
              The Right Ingredients for the Right Food. Eat Healthy, Delicious
              and Perfect Burgers From Our Hotel
            </h3>
            <h3 className="mt-4">
              Call us to order: <a href="tel:+1 123 456 789">+1 123 456 789</a>{" "}
            </h3>
            <a
              href="contact.html"
            ...
            <a
              href="#book"
              className="btn btn-style btn-outline-primary mt-sm-5 mt-4"
            >
              Book a table
            </a>
          </div>
      ...
      <div className="w3l-gallery2" id="gallery">
        <div className="burger galleryks py-5">
          <div className="container py-lg-4 py-md-3">
            ...
            <h3 className="title-big mb-lg-5 mb-4 text-center">
              Our Burger Gallery
            </h3>
            <div className="row no-gutters masonry">
              <div className="col-lg-3 col-md-4 col-sm-6">
                <a
                  ...
                  className="js-img-viwer d-block"
                  data-caption="The Right Ingredients for the Right Food."
                  data-id="lion"
                >
                  <img
          ...
          <div className="container">
            ...
            <div className="row main-cont-wthree-fea mt-5 pt-lg-4 text-center">
              <div className="col-lg-3 col-sm-6 grids-feature">
                ...
                <p>
                  Dolor et sed amet eget volutp elit libero. timpus sed elit
                  nibh quis dui, nunc tortor sit amet.
                </p>
              </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 app4-left-text">
                ...
                <p className="mt-3">
                  {" "}
                  Suspendisse efficitur orci urna. In et augue ornare, tempor
                  massa in, luctus sapien. Proin a diam et dui fermentum
                  molestie vel id neque. Donec sed tempus enim, a congue risus.
                  euismod massa a quam interdum.{" "}
                </p>
                ...
                <div className="download-link">
                  <h5 className="mb-2">
                    Enter your email to get download link
                  </h5>
